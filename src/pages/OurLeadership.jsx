  ...
  return (
    <div className="font-suse">
      ...
      <div className="py-20 text-center px-4">
        <h4 className="max-w-screen-sm mx-auto text-xl">
        ...
        <div className="flex justify-center gap-4 pb-5 pt-16">
          <h4 className="font-bold text-[#0066B2] text-xl border-r-2 pr-4 border-black">
            board of directors
          </h4>
          <h4 className="font-bold text-[#0066B2] text-xl">
            corporate officers
          </h4>
        </div>

        <h4 className="max-w-screen-sm mx-auto text-xl">
          Guided by our vision and values, The Chevron Way, our Board of
          Directors and Corporate Officers are committed to demonstrating the
          highest standard of ethics.
        </h4>

        <h2 className="text-4xl font-semibold text-[#0B2D71] tracking-wide pt-20 text-center">
          meet our leaders
        </h2>
      ...
      {leadersData.map(data => (<div key={data.id} className="px-4"><LeaderCard data={data} /></div>))}
