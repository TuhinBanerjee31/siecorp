    ...
    <div className="">
      ...
      <div className="max-w-screen-lg mx-auto text-center min-h-[40vh] flex flex-col gap-4 justify-center px-4 pt-14">
        ...
        <h5 className="font-suse text-3xl tracking-wide">
          Our dedicated professional team is ready to assist you with any
          business or general inquiries you may have. Whether you need support,
          information, or guidance, we're just a call or an email away.
        </h5>
      </div>
          ...
          <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-suse">
            <div className="flex flex-col gap-14">
              ...
              <ul className="flex mt-12 space-x-4">
                <li className="bg-[#009DD9] hover:bg-[#009DD9e2] transition-colors h-10 w-10 rounded-full flex items-center justify-center shrink-0">
            ...
            <div className="bg-gray-100 p-6 rounded-lg">
              ...
              <form className="mt-8 space-y-4">
                <input
                  type="text"
                  placeholder="Name"
                  className="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#009DD9]"
                />
                <input
                  type="text"
                  placeholder="Phone"
                ...
                <textarea
                  placeholder="Message"
                  rows="6"
                  className="w-full rounded-lg px-4 text-gray-800 text-sm pt-3 outline-[#009DD9]"
                ></textarea>
                <button
                  type="button"
                  className="text-white bg-[#009DD9] hover:bg-[#009DD9e2] transition-colors tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16px"
