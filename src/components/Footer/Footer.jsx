        ...
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <div className="flex items-center">
              <img src={logo} className="h-20 me-3" alt="Siecorp Logo" />
          ...
          <div className="grid grid-cols-2 gap-10 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-white font-medium flex flex-col gap-3">
                ...
                <li>
                  <p className="p">technology and innovation</p>
                </li>
                <li>
                  <p className="p">sustainability</p>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="text-white font-medium flex flex-col gap-3">
                ...
                <li>
                  <p className="p">investors events</p>
                </li>
                <li>
                  <p className="p">financial information</p>
                </li>
                <li>
                  <p className="p">stock information</p>
                </li>
                <li>
                  <p className="p">technology ventures</p>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="text-white font-medium flex flex-col gap-3">
                <li>
                  <p className="p">credit and gift cards</p>
                </li>
                <li>
                  <p className="p">texaco rewards</p>
                </li>
                <li>
                ...
                <li>
                  <p className="p">find a service station</p>
                </li>
              </ul>
            </div>
          </div>
