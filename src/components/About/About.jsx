  ...
  return (
    <div className="bg-[#07478F] min-h-screen font-suse">
      ...
      <div className="moving-title py-10 px-5 flex flex-col">
        <h1 className="md:text-9xl text-5xl font-bold text-[#009DD9] md:self-end self-center">precision</h1>
        <h1 className="md:text-9xl text-5xl font-bold text-[#0066B2] self-center">performance</h1>
        <h1 className="md:text-9xl text-5xl font-bold text-[#0B2D71] md:self-start self-center">progress</h1>
      </div>
